            ...
            <div class="col-12" data-aos="fade">
                ...
                <div class="row mb-3">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="mr-3 form-control border-0 px-4" placeholder="pekerjaan, keywords atau nama perusahaan ">
                        </div>
                        <div class="col-md-6 mb-3 mb-md-0">
                        <div class="input-wrap">
                            <span class="icon icon-room"></span>
                        <input type="text" class="form-control form-control-block search-input  border-0 px-4" id="autocomplete" placeholder="kabupaten atau kota" onFocus="geolocate()">
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                    <p class="small">atau cari berdasarkan kategori: <a href="#" class="category">Teknik Informasi</a> <a href="#" class="category">Sales Marketing</a></p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                <h2 class="mb-5">Kategori Lowongan Kerja</h2>
            </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                    ...
                    <img src="<?=base_url('assets/');?>images/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">
                    </div>
